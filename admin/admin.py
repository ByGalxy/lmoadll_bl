...
from var.sql.sqlite import get_user_role_by_identity, get_user_count, get_user_name_by_identity, get_site_option_by_name, get_or_set_site_option
...
def admin_set_name_options() -> Response:
    try:
        ...
        # 保存允许用户注册设置
        result_registration = get_or_set_site_option(db_prefix, sql_sqlite_path, 'enable_registration', enable_registration)
